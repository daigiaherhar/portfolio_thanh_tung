  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(alignment: Alignment.center, children: [
        ...
        InkWell(
          // onTap: () => controller.handleChangeTabBar(1),
          child: Container(
            decoration: BoxDecoration(
                border: Border.all(
                  width: 4,
        ...
        Positioned(
          left: 0,
          child: InkWell(
            // onTap: () => controller.handleChangeTabBar(0),
            child: Container(
              decoration: BoxDecoration(
                  border: Border.all(
                    width: 4,
        ...
        // AnimatedPositioned(
        //   curve: Curves.fastOutSlowIn,
        //   left: controller.tabBarModel.indexPage!.value == 0
        //       ? 0
        //       : controller.tabBarModel.indexPage!.value == 2
        //       ? (Get.width / 1.6) - 20
        //       : (Get.width / 3) - 20,
        //   right: controller.tabBarModel.indexPage!.value == 2 ? 0 : null,
        //   duration: Duration(milliseconds: 800),
        //   child: Container(
        //     width: Get.width / 2.5,
        //     padding: EdgeInsets.symmetric(vertical: 10, horizontal: 5),
        ...
        //     child: Center(
        //         child: Text(
        //           controller.tabBarModel.name!.value ?? "",
        //           style: TextStyle(color: ConstColors.lightWhite),
        //         )),
        //   ),
        // ),
      ]),
